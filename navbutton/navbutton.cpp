//QPushButton的派生类NavButton by zlx
//实现按钮的外形, 及悬停和点击时的样式改变
//Reference:https://gitee.com/feiyangqingyun/QWidgetDemo/tree/master/control
...
NavButton::NavButton(QWidget *parent) : QPushButton(parent)
{
    ...
    //分别设置正常状态/鼠标悬停状态/选中状态的按钮颜色
    normalBgColor = QColor(230, 230, 230);
    normalTextColor = QColor(80, 80, 80);
    hoverBgColor = QColor(140, 140, 140);
